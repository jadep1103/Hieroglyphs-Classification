...
# Charger l'historique
history_resnet50 = pd.read_csv('logs/history_ResNet50.csv')
...
# Courbe de loss
plt.subplot(1, 2, 1)
plt.plot(history_resnet50['epoch'], history_resnet50['train_loss'], label='Train Loss')
plt.plot(history_resnet50['epoch'], history_resnet50['val_loss'], label='Val Loss')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Loss Curve Updated - ResNet50')
plt.legend()
plt.grid()

# Courbe d'accuracy
plt.subplot(1, 2, 2)
plt.plot(history_resnet50['epoch'], history_resnet50['train_acc'], label='Train Accuracy')
plt.plot(history_resnet50['epoch'], history_resnet50['val_acc'], label='Val Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy (%)')
...
# Enregistrer la figure
save_path = f'logs/ResNet50_curves_{timestamp}.png'
plt.tight_layout()
plt.savefig(save_path, dpi=300)
print(f"Courbes sauvegardées sous : {save_path}")

# Charger l'historique
history_inception = pd.read_csv('logs/history_Inception.csv')
...
# Courbe de loss
plt.subplot(1, 2, 1)
plt.plot(history_inception['epoch'], history_inception['train_loss'], label='Train Loss')
plt.plot(history_inception['epoch'], history_inception['val_loss'], label='Val Loss')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Loss Curve Updated - Inception')
plt.legend()
plt.grid()

# Courbe d'accuracy
plt.subplot(1, 2, 2)
plt.plot(history_inception['epoch'], history_inception['train_acc'], label='Train Accuracy')
plt.plot(history_inception['epoch'], history_inception['val_acc'], label='Val Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy (%)')
plt.title('Accuracy Curve - ResNet50')
plt.legend()
...
# Enregistrer la figure
save_path = f'logs/Inception_curves_{timestamp}.png'
plt.tight_layout()
plt.savefig(save_path, dpi=300)
print(f"Courbes sauvegardées sous : {save_path}")