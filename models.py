...
from torchvision.models import ResNet18_Weights, EfficientNet_B0_Weights, DenseNet121_Weights, ResNet50_Weights,Inception_V3_Weights
...
def get_models(num_classes):
    ...
    models_dict['Inception'] = inception
