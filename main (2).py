def get_transforms(pretrained=False, mean_data=None, std_data=None,option=None):
    if pretrained:
...
if __name__ == "__main__":
    ...
    transform_inception = get_transforms(pretrained=False,mean_data=mean_data, std_data=std_data,option="inception")
    # transform_pretrained = get_transforms(pretrained=True)

    # Datasets (deux versions)
    train_loader_scratch, val_loader_scratch, test_loader_scratch, num_classes = load_datasets(train_dir, val_dir, test_dir, transform_scratch)
    train_loader_inception, val_loader_inception, test_loader_inception, num_classes = load_datasets(train_dir, val_dir, test_dir, transform_inception)
